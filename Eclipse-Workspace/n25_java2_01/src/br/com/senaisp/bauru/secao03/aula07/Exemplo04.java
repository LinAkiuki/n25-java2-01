...
public class Exemplo04 {
	...
	public static void main(String[] args) {
		Scanner sc = new Scanner(Exemplo04.class.getResourceAsStream("teste_arquivo.txt"))
				.useLocale(Locale.US); // indicando que será utilizado o padrão americano
		/*
		 * while (sc.hasNext()) { String linha = sc.nextLine();
		...
		System.out.println(sc.nextLine()); //última linha
