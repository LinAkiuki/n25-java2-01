...
public class JavaFXExemplo03 extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		LinearGradient lg = new LinearGradient(0, 1, 1, 0, true, CycleMethod.NO_CYCLE,
				new Stop[] { new Stop(0, Color.BLACK), new Stop(0.5, Color.YELLOW), new Stop(1, Color.BLUE) });
		// Ângulo Foco, Dist Foco, CentroX, CentroY, Raio, Proporcional, Forma Ciclos
		// Gradiente, Stops
		RadialGradient rg = new RadialGradient(0, 0, 0.5, 0.5, 1, true, CycleMethod.NO_CYCLE,
				new Stop[] { new Stop(0, Color.YELLOW), new Stop(0.25, Color.RED), new Stop(0.5, Color.TRANSPARENT) });
		// Criar o triângulo
		Polygon triangulo = new Polygon(new double[] { 210.0, 10.0, 210.0, 210.0, 10.0, 210.0 });
		...
		// Adicionando o triângulo ao Group
