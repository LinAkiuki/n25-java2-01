...
public class JavaFXExercicio01 extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		// Criando a cena
		Scene cena = new Scene(noRoot, 800, 600, Color.AZURE);
	...
	private void criarComponentes(Group noRoot) {
		...
		HBox cmp01 = new HBox();
		Rectangle cmp02 = new Rectangle(100, 100, Color.CORNFLOWERBLUE);
		...
		// Ajustando posiçoes
		cmp01.setLayoutY(500);
		cmp01.setPrefWidth(400);
		// Ajustando a imagem
		cmp04.setLayoutX(600);
		cmp04.setLayoutY(50);
		// Ajustando o Texto
		// https://docs.oracle.com/javafx/2/text/jfxpub-text.htm
		cmp03.setLayoutX(200);
		cmp03.setLayoutY(300);
		...
		// Colocando contorno na letra
		cmp03.setStroke(Color.BLACK);
		cmp03.setStrokeWidth(5); // Espessura do contorno
		cmp03.setStrokeType(StrokeType.OUTSIDE); // Contorno pra fora
