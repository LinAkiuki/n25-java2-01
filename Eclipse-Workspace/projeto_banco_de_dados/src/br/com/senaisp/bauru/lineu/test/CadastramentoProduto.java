package br.com.senaisp.bauru.lineu.test;

import java.sql.SQLException;
import java.util.InputMismatchException;
import java.util.Scanner;

import br.com.senaisp.bauru.lineu.classes.Produto;
...
public class CadastramentoProduto {
	...
	private static void cadastrarProduto(Scanner sc) {
		...
		do {
			try {
				if (sc.hasNext())
					sc.nextLine(); // Se tiver algo ainda no scanner, capturamos na linha acima
